...
SAY @105001
IF ~~ THEN REPLY @115268 DO ~SetGlobal("B_FBOLT","LOCALS",1) IncrementGlobal("B_NCAN","LOCALS",1)~ EXIT
IF ~~ THEN REPLY @115267 GOTO B_Sel001
END

IF ~~ THEN BEGIN B_Sel102
SAY @105003
IF ~~ THEN REPLY @115269 DO ~SetGlobal("B_ASPLA","LOCALS",1) IncrementGlobal("B_NCAN","LOCALS",1)~ EXIT
IF ~~ THEN REPLY @115267 GOTO B_Sel001
END

IF ~~ THEN BEGIN B_Sel103
SAY @105005
IF ~~ THEN REPLY @115270 DO ~SetGlobal("B_CRAY","LOCALS",1) IncrementGlobal("B_NCAN","LOCALS",1)~ EXIT
IF ~~ THEN REPLY @115267 GOTO B_Sel001
END

IF ~~ THEN BEGIN B_Sel104
SAY @105007
IF ~~ THEN REPLY @115271 DO ~SetGlobal("B_SGRA","LOCALS",1) IncrementGlobal("B_NCAN","LOCALS",1)~ EXIT
IF ~~ THEN REPLY @115267 GOTO B_Sel001
END

IF ~~ THEN BEGIN B_Sel105
SAY @105009
IF ~~ THEN REPLY @115272 DO ~SetGlobal("B_INFA","LOCALS",1) IncrementGlobal("B_NCAN","LOCALS",1)~ EXIT
IF ~~ THEN REPLY @115267 GOTO B_Sel001
END

IF ~~ THEN BEGIN B_Sel106
SAY @105011
IF ~~ THEN REPLY @115273 DO ~SetGlobal("B_FRND","LOCALS",1) IncrementGlobal("B_NCAN","LOCALS",1)~ EXIT
IF ~~ THEN REPLY @115267 GOTO B_Sel001
END
/*
IF ~~ THEN BEGIN B_Sel107
SAY @105013
IF ~~ THEN REPLY @115274 DO ~SetGlobal("B_CHILL","LOCALS",1) IncrementGlobal("B_NCAN","LOCALS",1)~ EXIT
IF ~~ THEN REPLY @115267 GOTO B_Sel001
END
*/
